...
import { LucideIcon, X, Lock, Zap, Brain, Image, MessageSquare, Sparkles, PenTool, Users, Hash, Grid, Type, Award, Search, Eye } from 'lucide-react';
...
export function GameCard({ 
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      disabled={isLocked}
      className={`relative flex flex-col items-start p-6 rounded-3xl border-2 transition-all text-left w-full group shadow-lg hover:shadow-2xl overflow-hidden ${
        theme === 'dark' 
    ...
    >
      ...
      <div className={`relative w-16 h-16 rounded-2xl flex items-center justify-center mb-4 transition-all duration-300 group-hover:scale-110 ${
        colorClass 
      ...
      {/* Content */}
      <h3 className={`text-xl font-black mb-2 group-hover:text-indigo-500 transition-all duration-200 ${
